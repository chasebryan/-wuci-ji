...
if ! WUCIOS_SKIP_EVIDENCE_CONTRACT=1 WUCIOS_SKIP_PLANNER_MANIFEST_BINDING=1 WUCIOS_SKIP_PLANNER_OUTPUT_VOCABULARY=1 WUCIOS_SKIP_FOUNDATION_VALIDATION_REPORT=1 sh "$SCAFFOLD_VALIDATOR"; then
