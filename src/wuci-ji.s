...
_start:
    ...
    mov rdi, qword ptr [rsp + 16]
    lea rsi, [rip + cmd_frost_secp256k1_aggregate]
    call streq
    cmp eax, 1
    je run_frost_secp256k1_aggregate
