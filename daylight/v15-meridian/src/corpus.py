"""Negative-evidence corpus freezing for Daylight v15 Meridian.
...
SNAPSHOT_DOMAIN = "DAYLIGHT-v15-MERIDIAN-CORPUS-SNAPSHOT:"
...
def _snapshot_body(entries: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        "snapshot_version": "daylight-v15-meridian-corpus-snapshot-v0.1",
        "frozen": True,
